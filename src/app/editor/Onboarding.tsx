...
const STEPS = [
  {
    ...
    body: 'Click a sentence to take all of it. Click again to widen: sentence, paragraph, section.',
  },
  {
    id: 'make',
    anchor: 'dock',
    ...
    body: 'Drag one onto the highlight, or just click it. You see the scene before you let go.',
  },
  {
    id: 'prove',
    anchor: 'stage',
    ...
    body: 'A line is drawn back to the words it came from in the paper.',
  },
  {
    id: 'play',
    anchor: 'transport',
